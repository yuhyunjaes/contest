    ...
    <div id="wrap">
        ...
        <div class="sidemenu">
            <div class="sideheader">
                ...
                <div class="sidelogin">
                    <ul>
                        <li><a href="manager.php">관리자</a></li>
        ...
        <div class="notice" id="notice">
            <div class="notice_header">
                ...
                <div class="notice_none">
                    <div class="option">
                        <a style="<?php if($option === "all"){echo'color: orangered;';}?>" href="web.php?page=1&option=all&#notice" onclick="nonenext()">전체보기</a>
                        <a style="<?php if($option === "event"){echo'color: orangered;';}?>" href="web.php?page=1&option=event&#notice" onclick="nonenext()">이벤트</a>
                        <a style="<?php if($option === "nomal"){echo'color: orangered;';}?>" href="web.php?page=1&option=nomal&#notice" onclick="nonenext()">일반</a>
                    </div>
                </div>
            </div>
            ...
            <div class="notice_footer">
                <div class="back_box">
                    <?php
                        if($page > 1) {
                            echo'<a href="web.php?page='.($page - 1).'&option='.$option.'&#notice" onclick="nonenext()">이전</a>';
                        }
                    ?>
                </div>
                    ...
                    <?php
                        for($i = 1;$i <= $now_page;$i++) {
                            if($i == $page) {
                                ...
                                echo '<a href="web.php?page='.$i.'&option='.$option.'&#notice" onclick="nonenext()">'.$i.'</a>';
                            }
                        }
                    ?>
                </div>
                <div class="next_box">
                    <?php
                    if($page < $now_page) {
                        echo'<a href="web.php?page='.($page + 1).'&option='.$option.'&#notice" onclick="nonenext()">다음</a>';
                    }
                    ?>
                </div>
            </div>
