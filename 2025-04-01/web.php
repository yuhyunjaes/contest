            ...
            <div class="notice_header">
                ...
                <div class="notice_none">
                    <div class="option">
                        ...
                        <p>공지일자</p>
                        <a style="<?php if($order === "DESC"){echo'color: orangered';}?>" href="web.php?page=<?php echo $page?>&option=all&order=DESC&#notice" onclick="nonenext()">최신순</a>
                        <a style="<?php if($order === "ASC"){echo'color: orangered';}?>" href="web.php?page=<?php echo $page?>&option=all&order=ASC&#notice" onclick="nonenext()">오래된순</a>
                    </div>
                </div>
            </div>
